...
<head>
    ...
    @php
        ...
        $ogImage = $seo['image'] ?? asset('images/PhuocLocBlogLogoHeader.png');
    @endphp
    ...
    <script>
        (function(){var s=localStorage.getItem('blog-theme');var d=window.matchMedia('(prefers-color-scheme: dark)').matches;var dark=s==='dark'||(s==null&&d);document.documentElement.classList.toggle('dark',dark);document.documentElement.classList.toggle('light',!dark);})();
    </script>
